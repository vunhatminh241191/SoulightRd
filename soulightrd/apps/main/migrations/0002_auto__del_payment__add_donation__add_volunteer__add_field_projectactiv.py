...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectActivity.project'
        db.add_column(u'main_projectactivity', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='project_activity', to=orm['main.Project']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectActivity.project'
        db.delete_column(u'main_projectactivity', 'project_id')
